#Stats Modeling 2
#Exercise 4
#Polls - Augmented Probit Hierarchical Model (Albert & Chib)
...
#Read in data.
data = read.csv('/Users/ippjune/Documents/2019_Spring/StatsModeling/polls.csv', head = T)
attach(data)

#Read in functions.
source('/Users/ippjune/Documents/2019_Spring/StatsModeling/exe4_FUNCTIONS_polls.r')

#Remove missing observations (178 rows out of 2193 - 2015 in total now)
...
#Plot confidence intervals for fixed coeffic
...
plotCI(x=CI[,2],li=CI[,1],ui=CI[,3],xlab='Coefficients',ylab='',col=state.col,main='Bayesian Credible Intervals by State for P(Bush)',xaxt='n')
...
#Save plot to pdf file.
plotCI(x=CI[,2],li=CI[,1],ui=CI[,3],xlab='Coefficients',ylab='',col=edu.col,main='BC Intervals by Ed Level Above NoHS for P(Bush)',xaxt='n')
...
#Save plot to pdf file.
plotCI(x=CI[,2],li=CI[,1],ui=CI[,3],xlab='Coefficients',ylab='',col=age.col,main='BC Intervals by Age Level Above 18-29 for P(Bush)',xaxt='n')
...
plotCI(x=CI[,2],li=CI[,1],ui=CI[,3],xlab='Coefficients',ylab='',col=rg.col,main='BC Intervals by Race and Gender for P(Bush)',xaxt='n')
