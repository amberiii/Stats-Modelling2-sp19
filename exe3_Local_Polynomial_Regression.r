...
#Load data.
utilities = read.csv('/Users/ppj/Documents/2019_Spring/StatsModeling/utilities.csv',header=T)
...
yhat_others = local_poly_smoother(x,y,x,h=5.5,K_gaussian,D=1)$yhat
